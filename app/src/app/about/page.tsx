    ...
    <div className="min-h-screen hero-gradient">
      ...
      <section className="pt-32 pb-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2 bg-white shadow-sm border border-gray-100 rounded-full px-4 py-1.5 mb-8">
          ...
          <span className="text-xs font-medium text-gray-500">Notre histoire</span>
        </div>
        ...
        <p className="text-gray-600 text-xl leading-relaxed max-w-3xl mx-auto">
          ...
          <strong className="text-gray-900"> rendre l'apprentissage et le savoir accessibles</strong> à chacun grâce à la technologie.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="text-center mb-14">
          <p className="text-green-600 text-sm font-medium mb-2">Simple & rapide</p>
            ...
            {steps.map((step, i) => (
              <div key={i} className="relative text-center">
                <div className="relative mx-auto w-24 h-24 mb-6">
                  ...
                  <div className="relative w-full h-full rounded-full bg-white shadow-sm border border-gray-100 flex flex-col items-center justify-center border border-gray-300">
                    <step.icon size={24} className="text-green-600 mb-1" />
                    <span className="text-xs text-green-600 font-bold">{step.number}</span>
                  </div>
                </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {values.map((value, i) => (
            <div key={i} className="bg-white shadow-sm border border-gray-100 rounded-2xl p-6 hover:border-purple-500/40 transition-all duration-300">
      ...
      {/* CTA */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="bg-white shadow-sm border border-gray-100 rounded-3xl p-10 text-center glow-purple relative overflow-hidden">
