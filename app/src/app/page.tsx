    ...
    <div className="hero-gradient">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div key={i} className="glass rounded-2xl p-6 group hover:border-purple-500/40 transition-all duration-300">
              ...
              <p className="text-sm text-emerald-800 leading-relaxed">{f.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {featuredBooks.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="flex items-center justify-between mb-10">
            <div>
              <p className="text-pink-500 text-sm font-medium mb-1">⭐ Sélection</p>
              <h2 className="text-3xl font-bold text-emerald-950">Livres populaires</h2>
            </div>
      ...
      {categories.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          ...
          <h2 className="text-2xl font-bold text-emerald-950 mb-8 text-center">
