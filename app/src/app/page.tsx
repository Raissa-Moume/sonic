    ...
    <div className="hero-gradient">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div key={i} className="bg-white shadow-sm border border-gray-100 rounded-2xl p-6 group hover:border-purple-500/40 transition-all duration-300">
              <div
      ...
      {featuredBooks.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="flex items-center justify-between mb-10">
            <div>
              <p className="text-green-600 text-sm font-medium mb-1">⭐ Sélection</p>
              <h2 className="text-3xl font-bold text-gray-900">Livres populaires</h2>
            </div>
      ...
      {/* CTA Banner */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="relative bg-white shadow-sm border border-gray-100 rounded-3xl overflow-hidden p-10 text-center glow-purple">
