  ...
  return (
    <div className="min-h-screen pt-24 pb-20 flex flex-col items-center justify-center hero-gradient">
      <div className="max-w-lg mx-auto px-4 text-center">
        ...
        <div className="bg-white shadow-sm border border-gray-100 rounded-2xl p-6 mb-8 text-left">
          <h2 className="font-semibold text-gray-900 mb-4">Que se passe-t-il maintenant ?</h2>
          {[
            ...
            <div key={i} className="flex items-start gap-3 mb-3 last:mb-0">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">{item.step}</p>
            </div>
          ))}
        </div>
