...
export default function BookDetailClient({ book, related }: BookDetailClientProps) {
  ...
  return (
    <div>
      <Link href="/books" className="inline-flex items-center gap-2 text-gray-400 hover:text-white text-sm mb-8 transition-colors">
        <ArrowLeft size={14} />
        Retour au catalogue
      </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-400 mb-6">par <span className="text-purple-400">{book.author}</span></p>
          ...
          <div className="glass rounded-2xl p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-gray-400 text-xs mb-1">Disponibilité</p>
                {book.stock > 0 ? (
          ...
          <div className="glass rounded-xl p-4">
            ...
            {[
              ...
              <p key={step} className="text-sm text-gray-300 mb-1">{step}</p>
            ))}
          </div>
        </div>
      </div>
      ...
      {related.length > 0 && (
        <div>
          ...
          <h2 className="text-xl font-bold text-white mb-6">Livres similaires</h2>
